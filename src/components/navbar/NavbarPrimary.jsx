            ...
            <div className='relative flex items-center justify-between h-16'>
              ...
              <div className='absolute inset-y-0 right-0 items-center pr-2 lg:static lg:inset-auto lg:ml-6 lg:pr-0 hidden lg:flex'>
                ...
                <div className='hidden lg:block space-x-4 ml-4'>
                  <button
                    type='button'
                    className='px-8 py-2 shadow-sm rounded-full text-[0.9rem] bg-gradient-to-r from-[#30223b] to-[#521523] text-white hover:text-white focus:outline-none transition duration-200 transform hover:scale-105 font-medium'
                  >
                    Connect Wallet
                  </button>
                </div>
          ...
          <Disclosure.Panel className='lg:hidden'>
            <div className='px-2 pt-2 pb-3 space-y-1 bg-ebony-500'>
              ...
              <Disclosure.Button as='div'>
                <button
                  type='button'
                  className='mt-3 px-8 py-2 shadow-sm rounded-lg text-[0.9rem] bg-gradient-to-r from-[#30223b] to-[#521523] text-white hover:text-white focus:outline-none transition duration-200 transform hover:scale-105 font-medium w-full'
                >
                  Connect Wallet
                </button>
              </Disclosure.Button>
